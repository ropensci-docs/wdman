...
- Fixing Mac install problem introduced by new chromedriver binaries for
  Mac M1 ([\#26](https://github.com/ropensci/wdman/issues/26))

## wdman 0.2.5

CRAN release: 2020-01-31

- Replaced subprocess (archived in CRAN) with
  [processx](https://processx.r-lib.org/).
...
- Fixed issue with checking for JAVA (thanks Michal Libura
  [\#15](https://github.com/ropensci/wdman/issues/15))
...
- Fixed an issue with Windows and blocking pipes. A batch file is now
  ran with stdout/stderr piped to file.
...
- Set default PhantomJS version to 2.1.1 (2.5.0-beta runs old
  ghostdriver currently).
